...
const Card: React.FC<CardProps>= ({tabs, selections, handleChange, total, priceTable}) => {
    ...
    return(
    <div className="bg-white w-3/4 rounded-2xl shadow-md -mt-16 flex flex-col items-center relative z-20">
            {/*Abas*/}
        ...
        <div className="flex items-center w-full justify-between mt-12 mb-8 px-12">
           ...
           <div className="flex-1">
            ...
            <div className="flex justify-center gap-4">
                < GenerateDOC selections={selections} total={total} tabs={tabs} priceTable={priceTable}/>
            </div>
        </div>    
    </div>
);
